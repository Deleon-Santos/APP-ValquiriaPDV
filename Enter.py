...
imagem_label.grid(row=0, column=0, padx=(20, 0), pady=(
    20, 10))  # Posição da imagem no layout
...
senha_entry = ctk.CTkEntry(master=form_frame, show="*", textvariable=senha_var, font=(
    'any', 18), width=300)  # Campo de entrada de senha (oculta os caracteres)
...
# Posição do botão SUPORTE
suporte_button.grid(row=0, column=2, padx=10, pady=20)

# Inicia a aplicação e mantém a janela_login aberta até que seja fechada
